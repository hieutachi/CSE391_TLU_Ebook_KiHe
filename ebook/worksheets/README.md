...
P06–08  JS: nền → render/filter → ★ Dashboard CRUD có Form Thêm (mốc 1)
   ↓
P09–12  React: props → state → Create → ★ Ứng dụng CRUD hoàn chỉnh (mốc 2)
```
...
| [05](./phieu-05-responsive-campusmart.md) | 5 | `cse391-cm-05` | Dashboard tĩnh responsive 640/1024 + hero |
...
| [08](./phieu-08-module-localstorage.md) | 8 | `cse391-cm-08` | ★ Mốc 1: Dashboard CRUD có **Form Thêm** (module + persist + validate) |
...
| [12](./phieu-12-react-crud.md) | 12 | `cse391-cm-12` | ★ Mốc 2: **ứng dụng React CRUD hoàn chỉnh 2 thực thể** — kịch bản 5 bước |
...
| P05 → P06 | Dashboard tĩnh hoàn chỉnh |
| P06 → P07 | `data.js` + 5 hàm helper |
| P07 → P08 | `render(list)` + filter + sort |
| P08 → P09 | ★ Dashboard JS thuần có Form Thêm → React tự động hóa render |
